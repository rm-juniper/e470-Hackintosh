...
<details>
<summary><strong>Hardware Tested</strong></summary>

| Specifications      | Detail                                      |
| :------------------ | :------------------------------------------ |
| Computer model      | Lenovo ThinkPad E470 (Type: 20H1)           |
| Processor           | Intel Core i5-7500U (2C4T, 3.5Ghz)          |
| Memory              | 16GB DDR4                                   |
